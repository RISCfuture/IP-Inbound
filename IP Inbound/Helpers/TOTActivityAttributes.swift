...
struct TOTActivityAttributes: ActivityAttributes {
  ...
  /// The planned IP-to-target leg duration, in seconds. The progress ring treats this as its full
  /// extent: full at the IP (this far ahead of TOT) and empty at TOT.
  var ipToTargetDuration: TimeInterval
