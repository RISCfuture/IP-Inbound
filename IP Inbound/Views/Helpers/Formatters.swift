...
let distanceFormatStyle = Measurement<UnitLength>.FormatStyle(
  width: .abbreviated, usage: .asProvided, numberFormatStyle: distanceNumberFormatStyle)
...
let speedFormatStyle = Measurement<UnitSpeed>.FormatStyle(
  width: .abbreviated, usage: .asProvided, numberFormatStyle: speedNumberFormatStyle)

let localTOTFormatStyle = Date.FormatStyle(
  date: .omitted, time: .shortened, timeZone: .autoupdatingCurrent,
...
extension Bearing {
  struct FormatStyle: Foundation.FormatStyle {
    ...
    private static let headingFormatStyle = Measurement<UnitAngle>.FormatStyle(
      width: .narrow, usage: .asProvided, numberFormatStyle: headingNumberFormatStyle)
