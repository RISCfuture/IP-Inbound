...
struct CourseDeviation {
  ...
  static let fullScale = Measurement(value: 4, unit: UnitLength.nauticalMiles)
  ...
  /// left.
  let crossTrackDistance: Measurement<UnitLength>
  ...
  /// → fly left.
  var needleOffset: Double { -clampedRatio }
  ...
  func announcement(in unit: UnitLength = .nauticalMiles) -> String {
